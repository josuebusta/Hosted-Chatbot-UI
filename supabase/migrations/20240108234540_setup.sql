...
AS $$
DECLARE
  project_url TEXT := 'https://jhjvimxicqjxrahbnlwm.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImpoanZpbXhpY3FqeHJhaGJubHdtIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTczMDc1MjAyNiwiZXhwIjoyMDQ2MzI4MDI2fQ.Hoqu97e_dRmvfJhJD1zdsRReHzPsKc0HJhFXGpTsacw'; -- full access needed for http request to storage
